                            ...
                            repuestosReturn += `
                                <div class="list-element d-flex justify-content-between align-items-center mb-2 flex-column flex-md-row">
                                    ...
                                    <div class="list-element-actions col-md-3 d-flex justify-content-center">
                                        ...
                                        <input type="number" data-id="${repuesto.id}" min="0" ${(!settings.stock ? `max="${repuesto.myDisponibilidad}"`:'')} data-max="${repuesto.myDisponibilidad}" ${(repuesto.diponibilidad==0&&!settings.stock?'disabled':'')} class="form-control mr-2 repuesto-cantidad col-3" value="${(repuesto.diponibilidad==0?'0':'1')}">
