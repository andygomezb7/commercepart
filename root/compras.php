...
<!--     <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            <label for="correlativo">Numero:</label>
            <input type="text" name="correlativo" value="<?php echo ($editando) ? $compraExistente['correlativo'] : 'PED-' . substr(md5(time()),0,10); ?>" id="correlativo" class="form-control" required>
        </div>
        <div class="form-group col-md-3">
    ...
    <div class="form-row">
        ...
        <!--</div>-->
        <div class="form-group col-md-3">
            <label for="tipo_cambio">Numero de paquetes:</label>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            <label for="bodega">Sucursal A:</label>
        ...
        <div class="form-group col-md-3">
            <label for="proveedor">Sucursal B:</label>
    ...
    <button type="submit" name="guardar_compra" class="btn btn-primary btn-lg"  <?php echo (@$compraExistente['estado']==3||@$compraExistente['estado']==2 ? 'disabled' : ''); ?>>
        ...
        <?php echo ($editando) ? 'Guardar Edición' : 'Agregar Pedido'; ?>
    </button>
</form>
