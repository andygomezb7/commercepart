<?php
    ...
    if ($tipo == 102) {
        ...
        $parameters_page = array(
            'title' => 'Mensajeros',
            'header' => 'Agregar/editar mensajeros',
            'buttons' => array(
                array("name" => "<i class='fas fa-plus'></i> Agregar mensajero", "action" => "?tipo=3&agregar=1", "type" => "success")
            )
        );
        include('header.php');
        ...
        $parameters_page = array(
            'title' => 'Sucursales',
            'header' => 'Agregar/editar Sucursales'
        );
        include('header.php');
        include('bodegas.php');
    } else if ($tipo == 5) {
        ...
        $parameters_page = array(
            ...
            'header' => 'Envios',
            'buttons' => array(
                array("name" => "<i class='fas fa-plus'></i> Nuevo envio", "action" => "?tipo=14&agregar=1", "type" => "success")
            )
        );
        include('header.php');
        include('compras.php');
    ...
    <div class="container">
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2>Proximos envios</h2>
                    <small>Aqui figura los proximos envios que se realizaran</small>
                </div>
                <div class="card shadow-none">
                    <div class="card-body">
                        <table class="table table-striped table-bordered dt-responsive nowrap w-100" id="monedasTable">
