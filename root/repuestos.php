...
if (isset($_GET['editar']) || isset($_GET['agregar'])) {
    ...
    $bodegas = $db->query("SELECT id,nombre FROM bodegas")->fetch_all(MYSQLI_ASSOC);
    // Obtener la lista de categorias
    $categorias = $db->query("SELECT id,nombre FROM categorias")->fetch_all(MYSQLI_ASSOC);
    // Obtener la lista de marcas
    $marcas = $db->query("SELECT id,nombre FROM marcas_codigos")->fetch_all(MYSQLI_ASSOC);
}
?>
