...
switch ($method) {
    ...
    case 'proveedores':
        ...
        // Ejecutar la consulta y obtener los datos
        $start -= 1;
        $proveedores = $db->query("SELECT * FROM proveedores" . $search_ql . $order_ql . " LIMIT $start, $length")->fetch_all(MYSQLI_ASSOC);
    ...
    case 'clientes':
        ...
        // Ejecutar la consulta y obtener los datos
        $start -= 1;
        $clientes = $db->query("SELECT * FROM clientes" . $search_ql . $order_ql . " LIMIT $start, $length")->fetch_all(MYSQLI_ASSOC);
    ...
    case 'marcas_codigos':
        ...
        // Ejecutar la consulta y obtener los datos
        $start -= 1;
        $marcas_codigos = $db->query("SELECT * FROM marcas_codigos" . $search_ql . $order_ql . " LIMIT $start, $length")->fetch_all(MYSQLI_ASSOC);
