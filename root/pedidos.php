                ...
                $(document).ready(function() {
                    $('.repuesto-container').repuestoDropdown({
                        ...
                        callback: function(repuestoId, element) {
                            $('.ordenes_list').agregarOrden(element.id, element.titulo, element.descripcion, element.codigos, true, element.valor, parseInt(element.cantidad), parseInt(element.reserva), false, element.maxDisponible, element.maxReserva);
                        ...
                        ordenes.forEach(function(element) {
                            elements += `<tr>
                                            ...
                                            <td class="qty">
                                                ...
                                                ${(parseInt(element.reserva)>0 ? `<input class="form-control border border-dark" max="${element.maxreserva}" name="detalles[${element.id}][reserva]" oninput="$('.ordenes_list').modificarOrden(${element.id}, false, false, false, this.value);"  type="number" value="${element.reserva}" />` : `<input class="form-control border border-dark" name="detalles[${element.id}][reserva]" type="hidden" value="0" />`)}
                                                <input class="form-control" max="${element.maxdisponible}" name="detalles[${element.id}][cantidad]" oninput="$('.ordenes_list').modificarOrden(${element.id}, false, false, this.value);" type="number" value="${element.cantidad}" />
                                            </td>
